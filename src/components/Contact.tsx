    ...
    <div id="contact" className="section">
        ...
        <div className="email">
            ...
            <span>bartosznowickihq@gmail.com</span>
                  {false && <a href="https://www.facebook.com/BardoLanguageDevelopment" target="_blank" rel="noopener noreferrer" className="facebook-icon">
                      <FontAwesomeIcon icon={faFacebook} />
                  </a>}
        </div>
           {false && <div className="button-group">
               <button
